              ...
              // النص الخاص بالمنتج
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Row(
                            children: [
                              Icon(IconlyBold.calendar, color: Colori.maincolor,size: 15,),
                              Text("24.6.2024",style: TextStyle(fontSize: 12,color: Colors.grey),),
                              SizedBox(width: 10), // Add space between calendar and time
                              Icon(IconlyBold.time_circle, color: Colori.maincolor,size: 15,),
                              Text("15:30-16:30",style: TextStyle(fontSize: 12,color: Colors.grey),),
                            ],
                          ),
                        ),
                      ],
                ...
                trailing: SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text("Accepted",style: TextStyle(color: Colori.maincolor,),),
