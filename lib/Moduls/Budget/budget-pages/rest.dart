      ...
      ListView.separated(
        itemBuilder: (context, index) {
          return InkWell(
            ...
            child: ListTile(
               leading: Icon(Icons.paypal_rounded,color: Colors.red,size: 30,),
            //Container(
              //   width: 60.0,
              //   height: 60.0,
              ...
              subtitle: Column(
                ...
                children: [
                  ...
                  Text(
                    "\$${300.678}",style: TextStyle(fontSize: 12,color: Colors.grey),
                  ),
              ...
              trailing: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(height:
                      10,),
                    Text("Rest",style: TextStyle(color: Colors.red,),),
